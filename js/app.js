...
$("#C1").click(function() {
    $("#titre_overlay").text('Développer une application client - serveur');
...
$("#C2").click(function() {
    $("#titre_overlay").text('Développer une application web');
...
$("#C6").click(function() {
    $("#titre_overlay").text('Tourisme');
    $("#liste_overlay").html('<li>Sens du contact humain ;</li><br/>');
});

$("#C7").click(function() {
    $("#titre_overlay").text('Langues');
